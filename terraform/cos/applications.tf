module "alertmanager" {
  source             = "git::https://github.com/canonical/alertmanager-k8s-operator//terraform?ref=tf-provider-0"
...
module "catalogue" {
  source             = "git::https://github.com/canonical/catalogue-k8s-operator//terraform?ref=tf-provider-0"
...
module "grafana" {
  source             = "git::https://github.com/canonical/grafana-k8s-operator//terraform?ref=tf-provider-0"
...
module "loki" {
  source                           = "git::https://github.com/canonical/observability-stack//terraform/loki?ref=tf-provider-0"
...
module "mimir" {
  source                           = "git::https://github.com/canonical/observability-stack//terraform/mimir?ref=tf-provider-0"
  anti_affinity                    = var.anti_affinity
  channel                          = var.channel
  model_uuid                       = var.model_uuid
  s3_endpoint                      = var.s3_endpoint
...
module "opentelemetry_collector" {
  source             = "git::https://github.com/canonical/opentelemetry-collector-k8s-operator//terraform?ref=tf-provider-0"
...
module "ssc" {
  ...
  source      = "git::https://github.com/canonical/self-signed-certificates-operator//terraform?ref=tf-provider-0"
...
module "tempo" {
  source                           = "git::https://github.com/canonical/tempo-operators//terraform?ref=tf-provider-0"
  anti_affinity                    = var.anti_affinity
  channel                          = var.channel
  model_uuid                       = var.model_uuid
  s3_endpoint                      = var.s3_endpoint
...
module "traefik" {
  source             = "git::https://github.com/canonical/traefik-k8s-operator//terraform?ref=tf-provider-0"
