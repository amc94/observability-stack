...
resource "juju_integration" "mimir_tracing_opentelemetry_collector_send_traces" {
  ...
  application {
    name     = module.opentelemetry_collector.app_name
    endpoint = module.opentelemetry_collector.endpoints.send_charm_traces
  }
}


resource "juju_integration" "mimir_self_metrics_endpoint_opentelemetry_collector_metrics_endpoint" {
  model = var.model
...
resource "juju_integration" "mimir_logging_consumer_opentelemetry_collector_logging_provider" {
  model = var.model
...
resource "juju_integration" "loki_logging_consumer_opentelemetry_collector_logging_provider" {
  model = var.model
...
resource "juju_integration" "loki_logging_opentelemetry_collector_logging_consumer" {
  model = var.model
...
resource "juju_integration" "loki_tracing_opentelemetry_collector_traicing_provider" {
  model = var.model
...
resource "juju_integration" "tempo_tracing_opentelemetry_collector_tracing" {
  model = var.model
...
resource "juju_integration" "tempo_metrics_endpoint_opentelemetry_collector_metrics_endpoint" {
  model = var.model
...
resource "juju_integration" "tempo_logging_opentelemetry_collector_logging_provider" {
  model = var.model
...
resource "juju_integration" "grafana_tracing_opentelemetry_collector_traicing_provider" {
  model = var.model
